...
주피터 노트북을 제외하고 코딩을 할 때 argparse를 많이 사용한다. 하지만 많은 변수들이 있고 default값을 사용하고 싶지 않을 경우(파이썬 파일은 하나 사용하는데 configuration이 여러개인경우)에는 
yaml을 사용하여 설정값을 조절 할 수 있다. 어차피 하는 방법은 아니까 예제 코드만 적어두자
